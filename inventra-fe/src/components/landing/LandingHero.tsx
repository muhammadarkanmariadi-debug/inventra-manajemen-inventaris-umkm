        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 flex flex-col items-start">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.08] tracking-tight text-foreground">
              <Trans>Kelola Inventaris</Trans> <span className="text-brand-500 italic"><Trans>Cerdas</Trans></span> <Trans>untuk Bisnis Modern.</Trans>
            </h1>

            {/* Subheadline */}
            <p className="text-muted-foreground text-lg lg:text-xl max-w-xl leading-relaxed">
              <Trans>Dari pelacakan stok real-time hingga prediksi AI — Inventra membantu UMKM mengelola inventaris dengan akurasi, kecepatan, dan efisiensi tinggi.</Trans>
            </p>
