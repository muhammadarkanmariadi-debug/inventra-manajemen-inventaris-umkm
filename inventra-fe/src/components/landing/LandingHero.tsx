          ...
          <div className="space-y-8 flex flex-col items-start">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-brand-500/10 dark:bg-brand-500/15 rounded-full border border-brand-500/20">
              ...
              <span className="text-xs font-bold text-brand-500 tracking-widest uppercase">
                <Trans id="Platform Inventaris UMKM" />
              </span>
            </div>
            ...
            <p className="text-muted-foreground text-lg lg:text-xl max-w-xl leading-relaxed">
              <Trans id="Dari pelacakan stok real-time hingga prediksi AI — Inventra membantu UMKM mengelola inventaris dengan akurasi, kecepatan, dan efisiensi tinggi." />
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <CheckCircle />
                <Trans id="Gratis 14 hari" />
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle />
                <Trans id="Tanpa kartu kredit" />
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle/>
                <Trans id="Setup 5 menit" />
              </div>
            </div>
          </div>
