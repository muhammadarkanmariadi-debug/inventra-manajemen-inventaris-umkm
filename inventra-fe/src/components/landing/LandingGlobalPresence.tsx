      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold tracking-tight text-foreground">
            <Trans id="Mulai dalam 3 Langkah Mudah" />
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            <Trans id="Tidak perlu pengaturan rumit. Dari pendaftaran hingga pengelolaan penuh — semuanya bisa dilakukan dalam hitungan menit." />
          </p>
        </div>
