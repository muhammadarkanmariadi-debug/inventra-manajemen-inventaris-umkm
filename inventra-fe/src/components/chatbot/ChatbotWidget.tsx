...
export default function ChatbotWidget() {
  ...
  const QUICK_QUESTIONS = [
    _("Produk apa yang paling laris bulan ini?"),
    _("Bagaimana kondisi keuangan bisnis saya?"),
    _("Produk apa yang perlu di-restock?"),
    _("Berikan analisis keuntungan bisnis saya"),
  ];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 0,
      role: 'assistant',
      content: _("Halo! 👋 Saya adalah asisten AI Inventra. Saya bisa membantu Anda menganalisis data bisnis:\n\n• 📦 Stok & inventori\n• 💰 Keuangan & transaksi\n• 📊 Penjualan & tren\n\nSilakan tanyakan apa saja tentang bisnis Anda!"),
      timestamp: new Date(),
    },
  ]);
  ...
  const sendMessage = async (question?: string) => {
    ...
    try {
      ...
      if (res.status) {
        ...
        aiText = res.message || _("Maaf, saya tidak bisa menjawab saat ini.");
      }
      ...
      toast.error(_("Gagal mengirim pesan. Silakan coba lagi."));
    } finally {
      setSending(false);
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 p-3">
          <div className="flex items-end gap-2">
            <textarea
              ...
              placeholder={_("Tanyakan sesuatu...")}
              rows={1}
