        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h4 className="text-lg font-semibold text-gray-800 dark:text-white/90 lg:mb-6">
              <Trans>Informasi Bisnis</Trans>
            </h4>

            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                  <Trans>Nama Bisnis</Trans>
                </p>
        ...
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              <Trans>Edit Detail Bisnis</Trans>
            </h4>
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              <Trans>Perbarui informasi bisnis Anda.</Trans>
            </p>
          </div>
          <form className="flex flex-col" onSubmit={handleSave}>
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div>
                  <Label><Trans>Nama Bisnis</Trans></Label>
                  <Input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <Label><Trans>Telepon</Trans></Label>
                  <Input
                    type="text"
                ...
                <div className="lg:col-span-2">
                  <Label><Trans>Website</Trans></Label>
                  <Input
                    type="text"
                  ...
                  {({ open }) => {
                    return (
                      ...
                      >
                        ...
                        <span> <Trans>Upload Logo Bisnis Anda untuk mode terang</Trans></span>
                      </button>
                    );
                  }}
                </CldUploadWidget>
                ...
                >
                  {({ open }) => {
                    return (
                      ...
                      >
                        <CloudUpload className="w-full h-full" />
                        <span> <Trans>Upload Logo Bisnis Anda untuk mode gelap</Trans></span>
                      </button>
                    );
                  }}
                </CldUploadWidget>
