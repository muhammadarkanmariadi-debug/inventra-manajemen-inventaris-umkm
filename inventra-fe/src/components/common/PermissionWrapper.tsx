      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-10">
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold text-gray-800 dark:text-white/90">
            <Trans>Akses Ditolak</Trans>
          </h2>
          <p className="max-w-md text-gray-500 dark:text-gray-400">
            <Trans>Anda tidak memiliki izin yang diperlukan untuk mengakses halaman ini ({permission}). Silakan hubungi administrator jika Anda merasa ini adalah kesalahan.</Trans>
          </p>
          <button
            onClick={() => router.back()}
