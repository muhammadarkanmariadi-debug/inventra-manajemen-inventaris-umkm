...
export default function HelpPage() {
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle={_("Bantuan & FAQ")} />
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-8 max-w-4xl mx-auto">
        <h3 className="mb-6 text-xl font-bold text-gray-800 dark:text-white/90 text-center">
          <Trans>Pertanyaan yang Sering Diajukan</Trans>
        </h3>
        <p className="text-gray-500 dark:text-gray-400 text-center mb-8 text-sm">
          <Trans>Temukan jawaban atas pertanyaan umum terkait manajemen Inventra UMKM.</Trans>
        </p>
        ...
        <div className="mt-12 p-6 bg-brand-50 dark:bg-brand-500/10 rounded-xl text-center border border-brand-100 dark:border-brand-500/20">
          <h4 className="text-brand-800 dark:text-brand-300 font-semibold mb-2"><Trans>Masih butuh bantuan?</Trans></h4>
          <p className="text-brand-600 dark:text-brand-400 text-sm mb-4"><Trans>Tim support kami siap membantu Anda menyelesaikan masalah apa pun.</Trans></p>
          <button className="px-5 py-2 bg-brand-600 text-white rounded-lg text-sm font-medium hover:bg-brand-700 transition"><Trans>Hubungi Support</Trans></button>
        </div>
      </div>
    </div>
  );
