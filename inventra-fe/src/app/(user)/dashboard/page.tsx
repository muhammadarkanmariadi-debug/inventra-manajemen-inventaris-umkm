...
export default function DashboardPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      toast.error(_("Gagal memuat data dashboard"));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PermissionWrapper permission="Lihat Dashboard" breadcrumb="Dashboard">
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          <Trans>Ringkasan bisnis Anda</Trans>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 mb-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              <Trans>Penjualan Bulan Ini</Trans>
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="rounded-xl shadow-lg p-4">
          <div className="flex justify-end gap-4">
            <div className="items-center gap-2 flex">
              <Label htmlFor="start-date"><Trans>Dari</Trans></Label>
              <DatePicker
                id="start-date"
            ...
            <div className="items-center gap-2 flex">
              <Label htmlFor="end-date"><Trans>Sampai</Trans></Label>
              <DatePicker
                id="end-date"
                placeholder="dd/mm/yy"
                onChange={(date: any) => {
        ...
        <div className="mt-5">
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            {loading ? (
              ...
              <div className="flex h-40 items-center justify-center text-gray-400">
                <Trans>Belum ada data produk</Trans>
              </div>
            ) : (
                ...
                {topProducts.map((product, index) => (
                  <div key={product.id} className="flex items-center gap-4 rounded-xl bg-gray-50 p-4 dark:bg-gray-800/50">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-400"><Trans>terjual</Trans></p>
                    </div>
                  </div>
                ))}
              </div>
