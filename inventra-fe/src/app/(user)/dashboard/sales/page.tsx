    ...
    <PermissionWrapper permission="Lihat Penjualan" breadcrumb="Penjualan">
      ...
      <div className='flex flex-col gap-4 mb-4'>
        ...
        <div className="flex justify-end gap-3">
          ...
          <Can permission="Tambah Penjualan">
            <Button size="sm" onClick={openCreateModal}>+ <Trans>Tambah Penjualan</Trans></Button>
          </Can>
        </div>
      </div>
            ...
            <Table>
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                <TableRow>
                  ...
                  <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>Pembeli</Trans></TableCell>
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {loading ? (
                  ...
                  <TableRow><TableCell className="px-5 py-8 text-center text-gray-500"><Trans>Tidak ada data penjualan</Trans></TableCell></TableRow>
                ) : (
      ...
      <Modal isOpen={showFormModal} onClose={() => { setShowFormModal(false); resetForm(); }} className="max-w-md p-6 lg:p-10">
        <h4 className="mb-6 text-lg font-semibold text-gray-800 dark:text-white/90">
          <Trans>Tambah Penjualan</Trans>
        </h4>
        <div className="space-y-4">
          <div>
            <Label><Trans>Batch Produk</Trans></Label>
            <Select
          ...
          {(formData.quantity > 0 && formData.selling_price > 0) && (
            <div className="rounded-xl border border-success-200 bg-gradient-to-r from-success-50/80 via-white to-success-50/50 p-5 shadow-sm dark:border-success-500/20 dark:from-success-500/10 dark:via-gray-900 dark:to-success-500/5">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h5 className="text-sm font-semibold text-gray-800 dark:text-white/90">
                      <Trans>Estimasi Pendapatan (Revenue Preview)</Trans>
                    </h5>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      <Trans>Kalkulasi estimasi pendapatan sebelum disimpan</Trans>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3.5 grid grid-cols-3 gap-4 text-sm">
                <div>
                  <span className="text-xs text-gray-500 dark:text-gray-400 block"><Trans>Kuantitas</Trans></span>
                  <span className="font-semibold text-gray-800 dark:text-white/90">
                    {formData.quantity} <Trans>unit</Trans>
                  </span>
                </div>
                <div>
                  <span className="text-xs text-gray-500 dark:text-gray-400 block"><Trans>Harga Satuan</Trans></span>
                  <span className="font-semibold text-gray-800 dark:text-white/90">
                    {formatCurrency(formData.selling_price)}
                  </span>
                </div>
                <div className="text-right">
                  <span className="text-xs text-gray-500 dark:text-gray-400 block"><Trans>Total Pendapatan</Trans></span>
          ...
          <div className="border-t border-gray-200 dark:border-white/10 pt-4 mt-2">
            <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3"><Trans>Data Pembeli (Opsional)</Trans></h5>
            <div className="space-y-3">
              <div>
                <Label><Trans>Nama Pembeli</Trans></Label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label><Trans>Alamat</Trans></Label>
      ...
      <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} className="max-w-sm p-6">
        <h4 className="mb-2 text-lg font-semibold text-gray-800 dark:text-white/90"><Trans>Hapus Penjualan</Trans></h4>
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
          <Trans>Apakah Anda yakin ingin menghapus penjualan ini?</Trans>
        </p>
        <div className="flex justify-end gap-3">
