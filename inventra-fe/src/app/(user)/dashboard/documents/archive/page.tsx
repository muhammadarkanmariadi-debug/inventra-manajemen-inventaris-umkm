      ...
      <div className="flex flex-col gap-4 mb-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
            ...
            <Trans>Total:</Trans> {total} <Trans>dokumen</Trans>
          </div>
          <button
          ...
          <div className="min-w-[1102px]">
            <Table>
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                <TableRow>
                  <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>No. Dokumen</Trans></TableCell>
                  ...
                  <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>Judul</Trans></TableCell>
                  <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>Dibuat</Trans></TableCell>
                  <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-end text-theme-xs dark:text-gray-400"><Trans>Aksi</Trans></TableCell>
                </TableRow>
              </TableHeader>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-12 text-center text-gray-400 dark:text-gray-500" colSpan={5}>
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm"><Trans>Belum ada dokumen yang dibuat</Trans></p>
                      </div>
                    </TableCell>
                  </TableRow>
                ) : (
