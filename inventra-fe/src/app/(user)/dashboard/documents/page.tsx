...
export default function DocumentsPage() {
  ...
  return (
    <PermissionWrapper permission="Tambah Dokumen" breadcrumb="Buat Dokumen Inventaris">
    <div className="min-h-screen">
      {/* Page Header */}
      <PageBreadcrumb pageTitle="Buat Dokumen Inventaris" />
      <div className="mb-8 mt-2">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          <Trans>Pilih jenis dokumen untuk di-generate. Dokumen akan dibuat dalam format PDF dan dapat disimpan ke database.</Trans>
        </p>
      </div>
      ...
      {isGenerating && (
        <div className="flex items-center justify-center py-12">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400"><Trans>Generating dokumen PDF...</Trans></p>
          </div>
        </div>
      )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  <Trans>Dokumen siap diunduh atau disimpan ke database</Trans>
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Can permission="Tambah Dokumen">
                ...
                >
                  ...
                  <Trans>Simpan ke Database</Trans>
                </button>
              </Can>
              <button
