    ...
    <PermissionWrapper permission="Lihat Supplier" breadcrumb="Supplier">
      ...
      <div className='flex flex-col gap-4 mb-4'>
        ...
        <div className="flex justify-end gap-3">
          ...
          <Can permission="Tambah Supplier">
            <Button size="sm" onClick={openCreateModal}>+ <Trans>Tambah Supplier</Trans></Button>
          </Can>
        </div>
      </div>
          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>No.Telp</Trans></TableCell>
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"><Trans>Alamat</Trans></TableCell>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {loading ? (
                ...
                <TableRow><TableCell className="px-5 py-8 text-center text-gray-500"><Trans>Tidak ada data supplier</Trans></TableCell></TableRow>
              ) : (
      ...
      <Modal isOpen={showFormModal} onClose={() => { setShowFormModal(false); resetForm(); }} className="max-w-md p-6 lg:p-10">
        <h4 className="mb-6 text-lg font-semibold text-gray-800 dark:text-white/90">
          {editingSupplier ? <Trans>Edit Supplier</Trans> : <Trans>Tambah Supplier</Trans>}
        </h4>
        <div className="space-y-4">
          <div>
            <Label><Trans>Nama Supplier</Trans></Label>
          ...
          <div>
            <Label><Trans>No.Telp</Trans></Label>
      ...
      <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} className="max-w-sm p-6">
        <h4 className="mb-2 text-lg font-semibold text-gray-800 dark:text-white/90"><Trans>Hapus Supplier</Trans></h4>
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
          <Trans>Apakah Anda yakin ingin menghapus supplier</Trans> <strong>{deletingSupplier?.name}</strong>?
        </p>
        <div className="flex justify-end gap-3">
